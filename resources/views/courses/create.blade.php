                ...
                <div class="card-body">
                    <form action="{{ route('courses.store') }}" method="POST">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('duration_hours') is-invalid @enderror" 
                                           id="duration_hours" name="duration_hours" value="{{ old('duration_hours', 10) }}" min="1" required>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('total_lessons') is-invalid @enderror" 
                                           id="total_lessons" name="total_lessons" value="{{ old('total_lessons', 10) }}" min="1" required>
                                    @error('total_lessons')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="mb-3 form-check">
                            ...
                            <label class="form-check-label" for="is_published">Publish this course immediately</label>
                        </div>
